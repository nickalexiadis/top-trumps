	...
	public void initializeDeck() {
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				Integer[] arr = {parseInt(splited[1]), parseInt(splited[2]), parseInt(splited[3]), parseInt(splited[4]), parseInt(splited[5])};
				deck.add(new Cards(splited[0], (int) arr[0], (int) arr[1], (int)arr[2],  (int)arr[3], (int) arr[4]));

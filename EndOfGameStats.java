...
public class EndOfGameStats {
	...
	public static boolean isGameFinished(Player p1, Player p2, Player p3, Player p4) {
		if (p1.getHandSize()>0 && p2.getHandSize()==0 && p3.getHandSize()==0 && p4.getHandSize()==0) {
			return true;
		}else if (p1.getHandSize()==0 && p2.getHandSize()>0 && p3.getHandSize()==0 && p4.getHandSize()==0) {
			return true;
		}else if (p1.getHandSize()==0 && p2.getHandSize()==0 && p3.getHandSize()>0 && p4.getHandSize()==0) {
			return true;
		}else if (p1.getHandSize()==0 && p2.getHandSize()==0 && p3.getHandSize()==0 && p4.getHandSize()>0) {
	...
	public static String checkForWinner(Player p1, Player p2, Player p3, Player p4) {
		...
		if (p1.getHandSize()>0 && p2.getHandSize()==0 && p3.getHandSize()==0 && p4.getHandSize()==0) {
			...
			if (TopTrumpsCLIApplication.writingTestLogs) {
				TopTrumpsCLIApplication.testlog.log(Level.FINE, "The winner of the game" + p1.getPlayerID());
				}
			...
			//Write into Testlog, if active
			if (TopTrumpsCLIApplication.writingTestLogs) {
				TopTrumpsCLIApplication.testlog.log(Level.FINE, "The winner of the game" + p2.getPlayerID());
				}
			//End Testlog, if active
			...
			//Write into Testlog, if active
			if (TopTrumpsCLIApplication.writingTestLogs) {
				TopTrumpsCLIApplication.testlog.log(Level.FINE, "The winner of the game" + p3.getPlayerID());
				}
			//End Testlog, if active
			...
			//Write into Testlog, if active
			if (TopTrumpsCLIApplication.writingTestLogs) {
				TopTrumpsCLIApplication.testlog.log(Level.FINE, "The winner of the game" + p4.getPlayerID());
				}
			//End Testlog, if active
